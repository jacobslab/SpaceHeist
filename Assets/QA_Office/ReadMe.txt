...
Use free Unity 'Post Processing Stack' camera effects, which is available through the Package Manager, and the adjusted profile for that, which can be founded at the QA_Office/Demo scene/ folder.
